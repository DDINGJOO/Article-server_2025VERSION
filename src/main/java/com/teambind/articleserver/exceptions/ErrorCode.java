...
public enum ErrorCode {
  ...
  ARTICLE_TYPE_MISMATCH("ART_ERR_005", "ARTICLE_TYPE_MISMATCH", HttpStatus.BAD_REQUEST),
  INVALID_EVENT_PERIOD("ART_ERR_006", "INVALID_EVENT_PERIOD", HttpStatus.BAD_REQUEST),
  INVALID_INPUT_VALUE("ART_ERR_007", "INVALID_INPUT_VALUE", HttpStatus.BAD_REQUEST),
  ;
