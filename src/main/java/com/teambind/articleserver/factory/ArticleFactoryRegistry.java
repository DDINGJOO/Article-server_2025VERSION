 ...
 *
 * <p>게시글 타입에 따른 적절한 팩토리를 제공합니다. Spring의 DI를 활용하여 모든 팩토리를 자동 주입받아 관리합니다.
 */
@Component
...
public class ArticleFactoryRegistry {
  ...
  public ArticleFactory getFactory(ArticleType type) {
    ...
    if (factory == null) {
      ...
      throw new CustomException(ErrorCode.INVALID_INPUT_VALUE, "Unsupported article type: " + type);
    }
    return factory;
  }
