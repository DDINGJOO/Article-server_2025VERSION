package com.teambind.articleserver.domain.aggregate;
...
import com.teambind.articleserver.domain.vo.*;
...
public abstract class ArticleAggregate extends AggregateRoot {
    ...
    protected void raiseArticleCreatedEvent() {
        registerEvent(new ArticleCreatedDomainEvent(
    ...
    public void delete(String reason) {
        ...
        // 도메인 이벤트 발행
        registerEvent(new ArticleDeletedDomainEvent(
            id, title, writerId, reason
        ));
    }
    ...
    public void addKeyword(Keyword keyword) {
        ...
        boolean exists = keywordMappings.stream()
            .anyMatch(mapping -> {
    ...
    public void removeKeyword(Keyword keyword) {
        keywordMappings.removeIf(mapping -> {
            Keyword k = mapping.getKeyword();
